...
for q in range(simulate_times):
    ...
    def get_next_guess(smart_guesses, prev_guess):
        ...
        # letterScores = {"e": 30, "a": 30, "r": 30, "i": 30, "o": 30, "t": 30, "n": 30, "s": 20, "l": 20, "c": 20,
        #                 "u": 20, "d": 20, "p": 20, "m": 20, "h": 20, "g": 20, "b": 20, "f": 10, "y": 10, "w": 10,
    ...
    while guess_count < 6:
        ...
        for i in range(len(curr_guess)):
            guess_letter = curr_guess[i]
            if (guess_letter not in green_letters) and (guess_letter not in yellow_letters) and (
                    guess_letter not in gray_letters):
        ...
        if curr_guess == actual_word:
            ...
            break
    frequency[guess_count + 1] += 1

print("——————————")
print("frequencies:", frequency)
accuracy = (simulate_times - frequency[7])/simulate_times * 100
